...
class LE_Event_List_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$this->le_widget_cssclass 	= 'le_event_list_widget';
		$this->le_widget_description = esc_html__( 'Displays the upcoming events in a list.', 'lastudio-events' );
		$this->le_widget_idbase 	= 'le_event_list_widget';
		$this->le_widget_name 	= esc_html__( 'Event list', 'lastudio-events' );

		/* Widget settings. */
		$widget_ops = array( 'classname' => $this->le_widget_cssclass, 'description' => $this->le_widget_description );

		/* Create the widget. */
		parent::__construct( 'le_event_list_widget', $this->le_widget_name, $widget_ops );
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'count' ) ); ?>"><?php esc_html_e( 'Count:', 'lastudio-events' ); ?></label>
