<?php
/*
Plugin Name:    Camille Package Demo Data
...
class Camille_Data_Demo_Plugin_Class{
    ...
    public static $theme_name = 'camille';

    public static $demo_site = 'https://camille.la-studioweb.com/';
...
add_action('plugins_loaded', array('Camille_Data_Demo_Plugin_Class','get_instance') );