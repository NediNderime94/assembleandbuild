<?php
/**
 * LaStudio Discography Metaboxes.
 *
 * @class LD_Admin_Metabox
 * @author LaStudio
 * @category Admin
...
if ( ! class_exists( 'LD_Admin_Metabox' ) ) {
	/**
	 * Metabox class
	 *
	...
	class LD_Admin_Metabox {
		...
		public function admin_scripts() {
			...
			/* Datepicker CSS */
			wp_enqueue_style( 'jquery-ui-custom', LD_CSS . '/admin/jquery-ui-custom.min.css', array(), LD_VERSION, 'all' );

			/* Sortable JS */
			wp_enqueue_script( 'jquery-ui-sortable' );

			/* Datepicker JS */
			wp_enqueue_script( 'lastudio-discography-datepicker', LD_JS . '/admin/datepicker.min.js', array( 'jquery-ui-datepicker' ), false, true );
			wp_enqueue_script( 'lastudio-discography-repeatable', LD_JS . '/admin/repeatable.min.js', array( 'jquery-ui-datepicker' ), false, true );
		}
		...
		public function render() {
			...
			echo '<table class="form-table lastudio-discography-metabox-table">';

			foreach ( $this->meta as $k => $v ) {

				if ( isset( $v['help'] ) ) {
					echo '<div class="lastudio-discography-metabox-help">' . $v['help'] . '</div>';
				}
			}
			...
			foreach ( $meta_fields as $field ) {
				...
				<td>";
					...
					// datepicker
						...
						echo '<input type="text" class="ld-metabox-datepicker" name="' . $field['id'] . '" id="' . $field['id'] . '" value="' . $meta . '" size="30">
						<br><span class="description">' . $desc . '</span>';

					// colorpicker
					} elseif ( 'colorpicker' == $type ) {

						echo '<input type="text" class="ld-options-colorpicker lastudio-colorpicker-input" name="' . $field_id . '" id="' . $field_id . '" value="' . $meta . '" />
						<br><span class="description">' . $desc . '</span>';

					// repeatable
					} elseif( 'repeatable' == $type ) {

						echo '<a class="ld-repeatable-add button" href="#">+</a>
								<ul id="'.$field['id'].'-repeatable" class="ld-custom_repeatable">';
						$i = 0;
						if ( is_array( $meta ) ) {
							...
							foreach( $meta as $row) {
								...
								echo '<li><span class="sort hndle">|||</span>
										<input type="text" name="' . $field['id'] . '['  .$i . ']" id="' . $field_id . '" value="' . esc_attr( $row ) . '" size="30" />
											<a class="ld-repeatable-remove button" href="#">-</a></li>';
								$i++;
							}
						} else {
							echo '<li><span class="sort hndle">|||</span>
					...
					<div>
						...
						<br><a href="#" class="button lastudio-options-reset-file"><?php esc_html_e( 'Clear', 'lastudio-discography' ); ?></a>
						<a href="#" class="button lastudio-options-set-file"><?php esc_html_e( 'Choose a file', 'lastudio-discography' ); ?></a>
					</div>
					...
					<div>
						...
						<br><a href="#" class="button lastudio-options-reset-img"><?php esc_html_e( 'Clear', 'lastudio-discography' ); ?></a>
						<a href="#" class="button lastudio-options-set-img"><?php esc_html_e( 'Choose an image', 'lastudio-discography' ); ?></a>
					</div>
					...
					-------------------------------------------*/
						...
						?>
						<p><?php esc_html_e( 'Background color', 'lastudio-discography' ); ?></p>
						...
						?>
						<p><?php esc_html_e( 'Background image', 'lastudio-discography' ); ?></p>
						<div>
							...
							<br><a href="#" class="button lastudio-options-reset-bg"><?php esc_html_e( 'Clear', 'lastudio-discography' ); ?></a>
							<a href="#" class="button lastudio-options-set-bg"><?php esc_html_e( 'Choose an image', 'lastudio-discography' ); ?></a>
						</div>
						<br><br>
						<?php
						}
						...
						?>
						<br>
						<p><?php esc_html_e( 'Background repeat', 'lastudio-discography' ); ?></p>
						...
						?>
						<br><br>
						<p><?php esc_html_e( 'Background position', 'lastudio-discography' ); ?></p>
						...
						--------------------*/
						$options = array(
							'cover' => esc_html__( 'cover (resize)', 'lastudio-discography' ),
							'normal' => esc_html__( 'normal', 'lastudio-discography' ),
							'resize' => esc_html__( 'responsive (hard resize)', 'lastudio-discography' ),
						);

						?>
						<br><br>
						<p><?php esc_html_e( 'Background size', 'lastudio-discography' ); ?></p>
						...
						if ( $parallax ) {
							?>
							<br><br>
							<p><strong><?php esc_html_e( 'Parallax', 'lastudio-discography' ); ?></strong></p>
					...
					-------------------------------------------*/
						...
						if ( ! in_array( 'color', $exclude_params ) ) {
						?>
						<p><?php esc_html_e( 'Font color', 'lastudio-discography' ); ?></p>
						...
						?>
							<p><?php esc_html_e( 'Font Family', 'lastudio-discography' ); ?></p>
							<select name="<?php echo esc_attr( $field_id ) . '_font_name'; ?>" id="<?php echo esc_attr( $field_id ) . '_font_name'; ?>">
								<option value=''><?php esc_html_e( 'default', 'lastudio-discography' ); ?></option>
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font weight', 'lastudio-discography' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( 'For example: 400 is normal, 700 is bold.The available font weights depend on the font.<br>Leave empty to use the theme default style', 'lastudio-discography' ); ?></span>
						<?php
						}

						if ( ! in_array( 'transform', $exclude_params ) ) {
							$options = array(
								'' => esc_html__( 'auto', 'lastudio-discography' ),
								'none' => esc_html__( 'none', 'lastudio-discography' ),
								'uppercase' => esc_html__( 'uppercase', 'lastudio-discography' ),
							);
						?>
							<br><br>
							<p><?php esc_html_e( 'Font transform', 'lastudio-discography' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( '"auto" is the default style in the theme options', 'lastudio-discography' ); ?></span>
						<?php
						}
						...
						if ( ! in_array( 'style', $exclude_params ) ) {
							$options = array(
								'' => esc_html__( 'auto', 'lastudio-discography' ),
								'normal' => esc_html__( 'normal', 'lastudio-discography' ),
								'italic' => esc_html__( 'italic', 'lastudio-discography' ),
							);
						?>
							<br><br>
							<p><?php esc_html_e( 'Font style', 'lastudio-discography' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( '"auto" is the default style defined in the theme options', 'lastudio-discography' ); ?></span>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font letter spacing (omit px)', 'lastudio-discography' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( 'Leave empty to use the style defined in the theme options', 'lastudio-discography' ); ?></span>
						<?php
						}
					...
					-------------------------------------------*/
						...
						?>
						<div>
							<p><strong><?php esc_html_e( 'mp4 URL', 'lastudio-discography' ); ?></strong></p>
						...
						<div>
							<p><strong><?php esc_html_e( 'webm URL', 'lastudio-discography' ); ?></strong></p>
						...
						<div>
							<p><strong><?php esc_html_e( 'ogv URL', 'lastudio-discography' ); ?></strong></p>
						...
						<div>
						<p><strong><?php esc_html_e( 'Video Image Fallback', 'lastudio-discography' ); ?></strong></p>
						<input type="hidden"  name="<?php echo esc_attr( $field_id ); ?>_img" id="<?php echo esc_attr( $field_id ); ?>_img" value="<?php echo esc_attr( $img ); ?>">
