<?php
/**
 * LaStudio Videos Metaboxes.
 *
 * @class LV_Admin_Metabox
 * @author LaStudio
 * @category Admin
...
if ( ! class_exists( 'LV_Admin_Metabox' ) ) {
	/**
	 * Metabox class
	 *
	...
	class LV_Admin_Metabox {
		...
		public function admin_scripts() {
			...
			/* Datepicker CSS */
			wp_enqueue_style( 'jquery-ui-custom', LV_CSS . '/admin/jquery-ui-custom.min.css', array(), LV_VERSION, 'all' );

			/* Slider JS */
			wp_enqueue_script( 'jquery-ui-sortable' );

			/* Datepicker JS */
			wp_enqueue_script( 'lastudio-videos-datepicker', LV_JS . '/admin/datepicker.min.js', array( 'jquery-ui-datepicker' ), false, true );
			wp_enqueue_script( 'lastudio-videos-repeatable', LV_JS . '/admin/repeatable.min.js', array( 'jquery-ui-datepicker' ), false, true );
		}
			...
			foreach ( $meta_fields as $field ) {
				...
				<td>";
					...
					// colorpicker
						...
						echo '<input type="text" class="wd-options-colorpicker lastudio-colorpicker-input" name="' . $field_id . '" id="' . $field_id . '" value="' . $meta . '" />
						<br><span class="description">' . $desc . '</span>';
					...
					<div>
						...
						<br><a href="#" class="button lastudio-options-reset-file"><?php esc_html_e( 'Clear', 'lastudio-videos' ); ?></a>
						<a href="#" class="button lastudio-options-set-file"><?php esc_html_e( 'Choose a file', 'lastudio-videos' ); ?></a>
					</div>
					...
					<div>
						...
						<br><a href="#" class="button lastudio-options-reset-img"><?php esc_html_e( 'Clear', 'lastudio-videos' ); ?></a>
						<a href="#" class="button lastudio-options-set-img"><?php esc_html_e( 'Choose an image', 'lastudio-videos' ); ?></a>
					</div>
					...
					-------------------------------------------*/
						...
						?>
						<p><?php esc_html_e( 'Background color', 'lastudio-videos' ); ?></p>
						...
						?>
						<p><?php esc_html_e( 'Background image', 'lastudio-videos' ); ?></p>
						<div>
							...
							<br><a href="#" class="button lastudio-options-reset-bg"><?php esc_html_e( 'Clear', 'lastudio-videos' ); ?></a>
							<a href="#" class="button lastudio-options-set-bg"><?php esc_html_e( 'Choose an image', 'lastudio-videos' ); ?></a>
						</div>
						<br><br>
						<?php
						}
						...
						?>
						<br>
						<p><?php esc_html_e( 'Background repeat', 'lastudio-videos' ); ?></p>
						...
						?>
						<br><br>
						<p><?php esc_html_e( 'Background position', 'lastudio-videos' ); ?></p>
						...
						--------------------*/
						$options = array(
							'cover' => esc_html__( 'cover (resize)', 'lastudio-videos' ),
							'normal' => esc_html__( 'normal', 'lastudio-videos' ),
							'resize' => esc_html__( 'responsive (hard resize)', 'lastudio-videos' ),
						);

						?>
						<br><br>
						<p><?php esc_html_e( 'Background size', 'lastudio-videos' ); ?></p>
						...
						if ( $parallax ) {
							?>
							<br><br>
							<p><strong><?php esc_html_e( 'Parallax', 'lastudio-videos' ); ?></strong></p>
					...
					-------------------------------------------*/
						...
						if ( ! in_array( 'color', $exclude_params ) ) {
						?>
						<p><?php esc_html_e( 'Font color', 'lastudio-videos' ); ?></p>
						...
						?>
							<p><?php esc_html_e( 'Font Family', 'lastudio-videos' ); ?></p>
							<select name="<?php echo esc_attr( $field_id ) . '_font_name'; ?>" id="<?php echo esc_attr( $field_id ) . '_font_name'; ?>">
								<option value=''><?php esc_html_e( 'default', 'lastudio-videos' ); ?></option>
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font weight', 'lastudio-videos' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( 'For example: 400 is normal, 700 is bold.The available font weights depend on the font.<br>Leave empty to use the theme default style', 'lastudio-videos' ); ?></span>
						<?php
						}

						if ( ! in_array( 'transform', $exclude_params ) ) {
							$options = array(
								'' => esc_html__( 'auto', 'lastudio-videos' ),
								'none' => esc_html__( 'none', 'lastudio-videos' ),
								'uppercase' => esc_html__( 'uppercase', 'lastudio-videos' ),
							);
						?>
							<br><br>
							<p><?php esc_html_e( 'Font transform', 'lastudio-videos' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( '"auto" is the default style in the theme options', 'lastudio-videos' ); ?></span>
						<?php
						}
						...
						if ( ! in_array( 'style', $exclude_params ) ) {
							$options = array(
								'' => esc_html__( 'auto', 'lastudio-videos' ),
								'normal' => esc_html__( 'normal', 'lastudio-videos' ),
								'italic' => esc_html__( 'italic', 'lastudio-videos' ),
							);
						?>
							<br><br>
							<p><?php esc_html_e( 'Font style', 'lastudio-videos' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( '"auto" is the default style defined in the theme options', 'lastudio-videos' ); ?></span>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font letter spacing (omit px)', 'lastudio-videos' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( 'Leave empty to use the style defined in the theme options', 'lastudio-videos' ); ?></span>
						<?php
						}

					/*  Video
					-------------------------------------------*/
					} elseif ( 'la_video' == $type ) {
						...
						?>
						<div>
							<p><strong><?php esc_html_e( 'mp4 URL', 'lastudio-videos' ); ?></strong></p>
						...
						<div>
							<p><strong><?php esc_html_e( 'webm URL', 'lastudio-videos' ); ?></strong></p>
						...
						<div>
							<p><strong><?php esc_html_e( 'ogv URL', 'lastudio-videos' ); ?></strong></p>
						...
						<div>
						<p><strong><?php esc_html_e( 'Video Image Fallback', 'lastudio-videos' ); ?></strong></p>
						<input type="hidden"  name="<?php echo esc_attr( $field_id ); ?>_img" id="<?php echo esc_attr( $field_id ); ?>_img" value="<?php echo esc_attr( $img ); ?>">
