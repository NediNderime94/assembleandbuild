...
class LaStudio_Shortcodes{
    ...
    public function vc_after_init(){
        ...
        if(class_exists('LaStudio_Playlist_Manager')){
            $config_file = self::$shortcode_path . 'configs/lastudio_playlist.php';
            if(file_exists( $config_file)){
        ...
        if(class_exists('LaStudio_Discography')){
            $config_file = self::$shortcode_path . 'configs/lastudio_last_releases.php';
            if(file_exists( $config_file)){
        ...
        if(class_exists('LaStudio_Videos')){
            $config_file = self::$shortcode_path . 'configs/la_last_video.php';
            if(file_exists( $config_file)){
        ...
        if(class_exists('LaStudio_Events')){
            $config_file = self::$shortcode_path . 'configs/lastudio_event_list.php';
            if(file_exists( $config_file)){
                vc_lean_map( 'lastudio_event_list', null, $config_file );
            }
        }

        add_action('vc_edit_form_fields_after_render', array( $this, 'add_js_to_edit_vc_form') );
