...
if ( $upsells ) : ?>
    ...
    $product_cols = shortcode_atts(
        ...
        Camille()->settings()->get('upsell_products_columns')
    );
    ...
    $title = Camille()->settings()->get('upsell_product_title') ? Camille()->settings()->get('upsell_product_title') : _x( 'You may also like&hellip;', 'front-view', 'camille' );
    $sub_title = Camille()->settings()->get('upsell_product_subtitle') ? Camille()->settings()->get('upsell_product_subtitle') : '';
    ?>
