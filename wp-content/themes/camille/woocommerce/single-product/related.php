...
if ( $related_products ) : ?>
	...
	$product_cols = shortcode_atts(
		...
		Camille()->settings()->get('related_products_columns')
	);
	...
	$title = Camille()->settings()->get('related_product_title') ? Camille()->settings()->get('related_product_title') : _x( 'Related Products', 'front-view', 'camille' );
	$sub_title = Camille()->settings()->get('related_product_subtitle') ? Camille()->settings()->get('related_product_subtitle') : '';
	?>
