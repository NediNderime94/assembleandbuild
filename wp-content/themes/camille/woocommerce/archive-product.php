...
$catalog_column = Camille()->settings()->get('woocommerce_catalog_columns', Camille()->settings()->get('woocommerce_shop_page_columns'));
...
$catalog_class[] = camille_render_grid_css_class_from_columns($catalog_column);

if ( camille_wc_product_loop() ) {
