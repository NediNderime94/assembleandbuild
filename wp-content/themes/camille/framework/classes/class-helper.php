...
if(!class_exists('Camille_Helper')){

    class Camille_Helper{
        ...
        public static function render_access_component( $type, $component = array(), $parent_name = '', $css_class = ''){
            ...
            if(!empty($component['text'])){
                $current_user_name = __('Guest', 'camille');
            ...
            switch($type){
                ...
                case 'text':
                    ...
                    if(!empty($component['text'])){
                        ...
                        $target_html .= apply_filters('camille/filter/component/text', $component['text']);
                        $target_html .= '</span>';
                        $target_html .= '</span>';
                    }
                    else{
                ...
                case 'link_text':
                    ...
                    if(!empty($component['text'])){
                        $icon_html .= '<span class="component-target-text">'. apply_filters('camille/filter/component/text', $component['text']) .'</span>';
                    }
                    $target_html = '<a rel="nofollow" class="component-target" href="'.$target_url.'">'.$icon_html.'</a>';
                    break;
