 ...
 * @return array
 */
function camille_metaboxes_section_footer( $sections )
{
    $sections['footer'] = array(
        ...
        'fields'    => array(
            array(
                ...
                'title'         => esc_html_x('Hide Footer', 'admin-view', 'camille'),
            ...
            array(
                ...
                'desc'          => esc_html_x('Controls the layout of the footer.', 'admin-view', 'camille'),
                'default'       => 'inherit',
                'options'       => Camille_Options::get_config_footer_layout_opts(false, true),
